...
from ....utils.postgres import PostgresSearchV2, PostgresSearch
...
class PostgresSearchFilter(filters.BaseFilterBackend):
    ...
    """
    search_version_attribute = 'search_version'
    ...
    search_vector_fields_attribute = 'search_vector_fields'
    search_vector_field_attribute = 'search_vector_field'
    ...
    def filter_queryset(self, request, queryset, view):
        ...
        search_version = self.get_search_version(view)
        ...
        search_vector_field = self.get_search_vector_field(view)
        ...
        raise ValueError(f'Search version {self.search_version} not supported')
    ...
    def get_search_version(self, view) -> str:
        return getattr(view, self.search_version_attribute, 'V1')
    ...
    def get_search_vector_fields(self, view) -> list:
        return getattr(view, self.search_vector_fields_attribute, [])

    def get_search_vector_field(self, view) -> list:
        return getattr(view, self.search_vector_field_attribute, None)
