...
class PostgresSearch:
    ...
    def get_word_similarity_annotate(queryset, search_fields: list, search: str) -> Tuple[QuerySet, list[str]]:
        ...
        for _search_field in search_fields:
            for _search in search.split(' '):
                word_similarities[f'{_search_field}_word_similarity_{_search}'] = TrigramWordSimilarity(
                    _search,
    ...
    @staticmethod
    def get_icontains_annotate(queryset, search_fields: list, search: str, add_rank_value: int = 1) -> Tuple[QuerySet, list[str]]:
        """
    ...
    @staticmethod
    def get_start_istartswith_annotate(queryset, search_fields: list, search: str, bonus_rank_startswith: float =1 ) -> Tuple[QuerySet, list[str]]:
        """
